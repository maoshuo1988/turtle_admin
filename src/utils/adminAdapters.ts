...
export function mapMarket(item: unknown): AdminMarket {
  ...
  return {
    ...
    listImage: pickString(context, 'listImage', 'list_image'),
    sideABgImage: pickString(context, 'sideABgImage', 'side_a_bg_image'),
    sideBBgImage: pickString(context, 'sideBBgImage', 'side_b_bg_image'),
